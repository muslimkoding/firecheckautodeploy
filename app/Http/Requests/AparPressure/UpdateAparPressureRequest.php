...
class UpdateAparPressureRequest extends FormRequest
{
    /**
    ...
    {
        $aparPressureId = $this->route('apar_pressure')->id;

        return [
            'name' => ['required', 'string', 'min:3', 'max:255', Rule::unique('apar_pressures')->ignore($aparPressureId)],
    ...
    {
        return [
            'name.required' => 'Nama tekanan APAR wajib diisi',
