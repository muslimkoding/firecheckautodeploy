...
<head>
    ...
    <title>Scan QR Code Hydrant</title>
                    ...
                    <div class="form-input">
                        <div class="scan-container p-4">
                            ...
                            <div class="text-center mb-4">
                                <h2 class="fw-bold text-primary">SCAN QR CODE Hydrant</h2>
                                <p class="text-muted">Arahkan kamera ke QR code Hydrant</p>
                            </div>
                            ...
                            <form action="{{ route('public.hydrant.scan.submit') }}" method="POST" id="scanForm">
                                @csrf
