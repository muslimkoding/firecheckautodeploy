...
class StoreAparHandleRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name' => 'required|string|min:3|max:255|unique:apar_handles,name',
