...
@section('breadcrumb')
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{ route('summary-apar.index') }}" class="text-decoration-none text-secondary">Summary</a></li>
        <li class="breadcrumb-item">APAR</li>
    </ol>
@endsection
...
<div class="card mb-4">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                {{-- <a href="{{ route('summary-apar.index') }}" class="text-decoration-none text-secondary">
