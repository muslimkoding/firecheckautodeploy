...
@section('title', 'Riwayat Pengecekan Hydrant')

@section('breadcrumb')
    <h1 class="mt-4">Riwayat Pengecekan Hydrant</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{ route('hydrant-check.index') }}" class="text-decoration-none text-secondary">Summary</a></li>
        <li class="breadcrumb-item ">Riwayat Pengecekan Hydrant</li>
    </ol>
@endsection
    ...
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <i class="fa-solid fa-table-list"></i> Summary Data Hydrant
            </div>
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('hydrant-check.scan') }}" class="btn btn-sm btn-primary">
    ...
    <div class="card-body p-1 bg-light">
        ...
        <div class="p-2">
            <div class="row mb-3">
                <div class="col-md-3">
                    ...
                    <select class="form-select form-select-sm" id="hydrant_id">
                        <option value="">Semua Hydrant</option>
                        @foreach($hydrants as $hydrant)
                            <option value="{{ $hydrant->id }}">{{ $hydrant->number_hydrant }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3">
                    <label class="form-label">Kondisi Hydrant</label>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control form-control-sm" id="search" placeholder="Cari nomor Hydrant, lokasi, pemeriksa...">
                </div>
        ...
        <div class="table-responsive">
            <div class="form-input">
                <table class="table border w-100 bg-white" id="hydrant-checks-table">
                    <thead>
...
$(document).ready(function() {
    var table = $('#hydrant-checks-table').DataTable({
        processing: true,
        serverSide: true,
        responsive: true,
        ajax: {
            url: "{{ route('hydrant-check.index') }}",
            data: function(d) {
                d.hydrant_id = $('#hydrant_id').val();
        ...
        columns: [
            ...
            { data: 'hydrant_door' },
            { data: 'hydrant_coupling' },
            { data: 'hydrant_main_valve' },
            { data: 'hydrant_hose' },
            { data: 'hydrant_nozzle' },
            { data: 'hydrant_safety_marking' },
            { data: 'hydrant_guide' },
            // { data: 'check_details' },
    ...
    $('#resetFilter').on('click', function() {
        $('#hydrant_id, #zone_id, #building_id, #group_id, #user_id, #condition_id').val('');
...
function confirmDelete(id) {
    Swal.fire({
        ...
        text: "Data pengecekan Hydrant yang dihapus tidak dapat dikembalikan!",
        icon: 'warning',
