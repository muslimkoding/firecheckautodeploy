...
class UpdateHydrantNozzleRequest extends FormRequest
{
    /**
    ...
    {
        $hydrantNozzleId = $this->route('hydrant_nozzle')->id;

        return [
            'name' => ['required', 'string', 'min:3', 'max:255', Rule::unique('hydrant_nozzles')->ignore($hydrantNozzleId)],
    ...
    {
        return [
            'name.required' => 'Nama kondisi nozzle Hydrant wajib diisi',
