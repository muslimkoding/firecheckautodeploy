            ...
            <form action="{{ route('apar.store') }}" method="POST">
              ...
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control @error('number_apar') is-invalid @enderror" 
                        ...
                        value="{{ old('number_apar') }}" required>
                  @error('number_apar')
                  ...
                  <div class="mb-2">
                    <small class="text-muted">Last created : 
                      <strong>{{ $lastApar ? $lastApar->number_apar : 'Belum ada data' }}</strong>
                    </small>
                  </div>
              </div>
              ...
              <div class="mb-3">
                  ...
                  <input type="number" step="0.01" class="form-control @error('weight_of_extinguiser') is-invalid @enderror" 
                        ...
                        value="{{ old('weight_of_extinguiser') }}" required>
              ...
              <div class="mb-3">
                ...
                <select name="apar_type_id" id="apar_type_id" class="form-select @error('apar_type_id')
                  is-invalid
                @enderror" required>
              <option value="">Pilih Tipe</option>
              @foreach ($aparTypes as $aparType)
                <option value="{{ $aparType->id }}" {{ old('apar_type_id') == $aparType->id ? 'selected' : '' }}>{{ $aparType->name }}</option>
              @endforeach
              </select>
