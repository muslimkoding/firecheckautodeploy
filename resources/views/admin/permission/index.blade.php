...
@section('breadcrumb')
    <h1 class="mt-4">Manajemen Permission</h1>
        ...
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('permission.create') }}" class="btn btn-sm btn-light bg-white border">
            ...
            <div class="p-2">
                <div class="row mb-4">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="search" placeholder="Cari nama permission...">
                    </div>
                    <div class="col-md-4">
    ...
    <script>
        $(document).ready(function() {
            var table = $('#permissions-table').DataTable({
                ...
                responsive: true,
                // order: [[0, 'desc']], // Default order by nama permission
                pageLength: 10,
