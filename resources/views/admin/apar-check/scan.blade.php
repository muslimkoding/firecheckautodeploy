...
@section('breadcrumb')
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{ route('apar-check.to-check') }}"
                class="text-decoration-none text-secondary">Checklist</a></li>
        <li class="breadcrumb-item">Scan APAR</li>
    </ol>
@endsection
                    ...
                    <div class="border-top pt-3">
                        ...
                        {{-- <div class="manual-input-section" id="manual-input-section" style="display: none;">
                            <form id="manual-form">
                                @csrf
                                <div class="mb-3">
                                    <label for="qr_code" class="form-label">Kode APAR Manual</label>
                                    <input type="text" class="form-control" id="qr_code" name="qr_code"
                                ...
                                <button type="button" onclick="location.reload()" class="btn btn-outline-secondary">
                                    <i class="fas fa-camera"></i> Kembali ke Scanner
                                </button>
                            </form>
                        </div>
