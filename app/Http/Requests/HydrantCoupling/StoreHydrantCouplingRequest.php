...
class StoreHydrantCouplingRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name' => 'required|string|min:3|max:255|unique:hydrant_couplings,name',
