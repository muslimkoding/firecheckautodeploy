...
@section('breadcrumb')
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item "><a href="{{ route('apar-handles.index') }}" class="text-decoration-none text-dark">Kondisi Handle APAR</a></li>
    </ol>
@endsection
    ...
    <div class="card mb-4">
        <div class="card-header">
            <div class="d-flex justify-content-between align-middle">
                ...
                <a href="{{ route('apar-handles.create') }}" class="btn btn-sm btn-light bg-white border">
                  ...
                  <table class="table border w-100 bg-white" id="datatables">
                    <thead>
                        <tr class="align-middle">
                            ...
                            <th>Nama Kondisi Handle APAR</th>
                            <th>Slug</th>
                            <th>Deskripsi</th>
