...
@section('breadcrumb')
    ...
    <ol class="breadcrumb mb-4">
      ...
      <li class="breadcrumb-item "><a href="{{ route('buildings.index') }}" class="text-decoration-none text-secondary">Gedung</a></li>
    ...
    <div class="card mb-4">
        <div class="card-header">
            <div class="d-flex justify-content-between align-middle">
              <div class="">
              <a href="{{ route('buildings.index') }}" class="text-decoration-none text-secondary"><i class="fas fa-arrow-left"></i> Kembali</a>
              </div>
            </div>
        </div>
            ...
            <form action="{{ route('buildings.update', $building->id) }}" method="post">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="name" id="name" class="form-control @error('name')
                  is-invalid
                @enderror" autofocus required value="{{ old('name', $building->name) }}">
              ...
              <div class="mb-3">
                ...
                <textarea name="description" id="description" cols="30" rows="5" class="form-control @error('description')
                  is-invalid
                @enderror" >{{ old('description', $building->description) }}</textarea>
