...
class StoreHydrantGuideRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name' => 'required|string|min:3|max:255|unique:hydrant_guides,name',
    ...
    {
        return [
            'name.required' => 'Nama petunjuk penggunaan hydrant wajib di isi',
            ...
            'name.unique' => 'Nama petunjuk penggunaan hydrant sudah ada',
