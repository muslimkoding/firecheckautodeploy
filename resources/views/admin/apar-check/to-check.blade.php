...
@push('css')
    ...
    <style>
        ...
        /* Kembalikan pagination ke tengah */
        .dataTables_paginate {
        ...
        <div class="card">
            ...
            <div class="card-body p-1 bg-light">
                <div class="table-responsive">
                    <div class="form-input">
                        <table class="table border table-striped w-100" id="apar-table">
...
@push('scripts')
    ...
    $(document).ready(function() {
        ...
        var table = $('#apar-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('apar-check.to-check') }}",
                data: function (d) {
            ...
            language: {
                processing: '<div class="spinner-border text-primary text-center" role="status"><span class="visually-hidden">Loading...</span></div> Memproses...',
                search: 'Cari:',
                ...
                emptyTable: 'Tidak ada data APAR yang perlu diperiksa',
                paginate: {
                    first: 'Pertama',
                    previous: 'Sebelumnya',
                    next: 'Selanjutnya',
