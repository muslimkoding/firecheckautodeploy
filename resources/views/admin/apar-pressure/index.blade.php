...
@section('breadcrumb')
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item "><a href="{{ route('apar-pressures.index') }}" class="text-decoration-none text-dark">Tekanan APAR</a></li>
    </ol>
@endsection
    ...
    <div class="card mb-4">
        <div class="card-header">
            <div class="d-flex justify-content-between align-middle">
                ...
                <a href="{{ route('apar-pressures.create') }}" class="btn btn-sm btn-light bg-white border">
    ...
    <script>
        $(document).ready(function() {
            $('#datatables').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('apar-pressures.index') }}",
                    type: 'GET'
                },
                columns: [
                    {
