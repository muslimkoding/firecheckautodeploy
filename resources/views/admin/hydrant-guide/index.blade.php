...
@section('breadcrumb')
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item "><a href="{{ route('hydrant-guides.index') }}" class="text-decoration-none text-dark">Petunjuk Penggunaan Hydrant</a></li>
    </ol>
@endsection
    ...
    <div class="card mb-4">
        <div class="card-header">
            <div class="d-flex justify-content-between align-middle">
                ...
                <a href="{{ route('hydrant-guides.create') }}" class="btn btn-sm btn-light bg-white border">
                  ...
                  <table class="table border w-100 bg-white" id="datatables">
                    <thead>
                        <tr class="align-middle">
                            ...
                            <th>Nama Petunjuk Penggunaan Hydrant</th>
                            <th>Slug</th>
                            <th>Deskripsi</th>
    ...
    <script>
        $(document).ready(function() {
            $('#datatables').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('hydrant-guides.index') }}",
                    type: 'GET'
                },
                columns: [
                    {
