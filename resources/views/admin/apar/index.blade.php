...
@section('title', 'Halaman Data APAR')

@section('breadcrumb')
    <h1 class="mt-4">Data APAR</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item "><a href="{{ route('apar.index') }}" class="text-decoration-none text-secondary">Mapping</a></li>
        <li class="breadcrumb-item ">Data APAR</li>
    </ol>
@endsection
    ...
    <div class="card mb-4">
        <div class="card-header">
            <div class="d-flex justify-content-between align-middle">
                ...
                <i class="fa-solid fa-table-list"></i> Data APAR
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('apar.create') }}" class="btn btn-sm btn-light bg-white border">
        ...
        <div class="card-body p-1 bg-light">
            ...
            <div class="p-2">
                <div class="row mb-4">
                    ...
                    <div class="col-md-2">
                        <label class="form-label">Tipe APAR</label>
                        <select class="form-select form-select-sm" id="apar_type_id">
                            <option value="">Semua Tipe</option>
                            @foreach($aparTypes as $type)
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select form-select-sm" id="expired_status">
                            <option value="">Semua Status</option>
                            <option value="expired">Kadaluarsa</option>
                            <option value="not_expired">Belum Kadaluarsa</option>
                ...
                <div class="row mb-4">
                    <div class="col-md-12">
                        <label class="form-label">Cari APAR</label>
                        <input type="text" class="form-control form-control-sm" id="search" placeholder="Cari APAR...">
                    </div>
                </div>
            </div>
...
<script>
        ...
        var table = $('#datatables').DataTable({
            ...
            ajax: {
                ...
                data: function(d) {
                    ...
                    d.apar_type_id = $('#apar_type_id').val();
                    d.condition_id = $('#condition_id').val();
                    d.status = $('#status').val();
                    d.expired_status = $('#expired_status').val();
                }
            },
            columns: [
                {
                ...
                {
                    data: 'formatted_weight',
                    name: 'weight_of_extinguiser'
                },
                {
                    data: 'zone.name',
                    name: 'zone.name'
            ...
            responsive: true,
            order: [[1, 'asc']], // Default order by nomor APAR
            pageLength: 10,
    ...
    function confirmDelete(id) {
        Swal.fire({
            ...
            text: "Data APAR yang dihapus tidak dapat dikembalikan!",
            icon: 'warning',
