...
@section('breadcrumb')
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item "><a href="{{ route('positions.index') }}" class="text-decoration-none text-dark">Jabatan</a></li>
    </ol>
@endsection
    ...
    <div class="card mb-4">
        <div class="card-header">
            <div class="d-flex justify-content-between align-middle">
                ...
                <a href="{{ route('positions.create') }}" class="btn btn-sm btn-light bg-white border">
